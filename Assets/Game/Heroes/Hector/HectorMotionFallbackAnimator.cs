...
public sealed class HectorMotionFallbackAnimator : MonoBehaviour
{
    ...
    void ApplyActionPose(HectorCombatAction action, float t)
    {
        switch (action)
        {
            case HectorCombatAction.BasicAttack: ApplyBasicAttack(t); break;
            case HectorCombatAction.WarCry: ApplyWarCry(t); break;
            case HectorCombatAction.ShieldWall: ApplyShieldDeploy(t); break;
            case HectorCombatAction.SpearThrow: ApplySpearThrow(t); break;
            case HectorCombatAction.Ultimate: ApplyUltimate(t); break;
        }
    }
