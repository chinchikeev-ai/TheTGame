...
public class GameUIController : MonoBehaviour
{
    ...
    void BuildUI()
    {
        ...
        CreateBuildPicker(canvas.transform); CreateSelectedPanel(canvas.transform);
