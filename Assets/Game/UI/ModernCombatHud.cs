...
public sealed class ModernCombatHud : MonoBehaviour
{
    ...
    {
        GameObject bar = Panel(parent, "TopResources", new Vector2(24, -24), new Vector2(400, 132), new Vector2(0, 1), new Vector2(0, 1));
        Image coin = Icon(bar.transform, "CoinIcon", new Vector2(-164, 34), new Vector2(42, 42), TroyHudArt.Icon("gold"));
        coin.color = Color.white;
        goldText = Text(bar.transform, "0", new Vector2(-126, 34), new Vector2(236, 46), 25, new Color(1f, .73f, .24f, 1f), TextAnchor.MiddleLeft, FontStyle.Bold);
        Icon(bar.transform, "GateIcon", new Vector2(-164, -34), new Vector2(42, 42), TroyHudArt.Icon("gate"));
        gateText = Text(bar.transform, L("GATE", "ВОРОТА"), new Vector2(-126, -23), new Vector2(236, 26), 14, new Color(.94f, .84f, .67f, 1f), TextAnchor.MiddleLeft, FontStyle.Bold);
        gateHealthFill = ProgressBar(bar.transform, "GateHealthProgress", new Vector2(48, -48), new Vector2(236, 14), new Color(.18f, .08f, .045f, 1f), new Color(.79f, .22f, .08f, 1f));
    }

    void BuildWaveBar(Transform parent)
    {
        waveBar = Panel(parent, "WaveStatus", new Vector2(0, -24), new Vector2(760, 152), new Vector2(.5f, 1), new Vector2(.5f, 1));
        Icon(waveBar.transform, "WaveCrest", new Vector2(-338, 28), new Vector2(58, 58), TroyHudArt.Icon("sword"));
    ...
    {
        GameObject panel = Panel(parent, "CombatActions", new Vector2(-24, -24), new Vector2(370, 132), new Vector2(1, 1), new Vector2(1, 1));
    ...
    {
        firstWavePrep = Panel(parent, "FirstWavePreparation", new Vector2(0, -176), new Vector2(760, 330), new Vector2(.5f, 1f), new Vector2(.5f, 1f));
    ...
    {
        buildDock = Panel(parent, "BuildDock", new Vector2(-104f, 24f), new Vector2(1040, 148), new Vector2(1f, 0f), new Vector2(1f, 0f));
    ...
    {
        buildTooltip = Panel(parent, "BuildHoverTooltip", new Vector2(-104f, 190f), new Vector2(500, 166), new Vector2(1f, 0f), new Vector2(1f, 0f));
    ...
    {
        selectedCard = Panel(parent, "SelectedTowerCard", Vector2.zero, new Vector2(340, 274), new Vector2(.5f, .5f), new Vector2(.5f, .5f));
