    ...
    void ApplyBaseStats()
    {
        switch (Type)
        {
            case TowerType.MachineGun:
                range = 5.8f; damage = 16f; fireRate = 4.2f; projectileSpeed = 18f; splashRadius = 0f; slowMultiplier = 1f; slowDuration = 0f;
                break;
            case TowerType.Cannon:
                range = 6.8f; damage = 72f; fireRate = 0.75f; projectileSpeed = 10f; splashRadius = 2.2f; slowMultiplier = 1f; slowDuration = 0f;
                break;
            case TowerType.Slow:
                range = 5.3f; damage = 9f; fireRate = 1.5f; projectileSpeed = 13f; splashRadius = 0f; slowMultiplier = 0.55f; slowDuration = 1.6f;
                break;
        }
    }
