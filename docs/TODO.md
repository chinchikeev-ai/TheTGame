...
- Все боевые HUD-блоки используют единый троянский стиль и не перекрываются в RU/EN на 1920x1080 и 1366/1376x768.
- «Божественная буря» представлена одной понятной кнопкой без дублирующего углового элемента.
